...
public class FragmentWorker extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        total_avg = (TextView) view.findViewById(R.id.total_avg);
        unit_total_current = (TextView)view.findViewById(R.id.unit_total_current);
        unit_total_reported = (TextView) view.findViewById(R.id.unit_total_reported);
        unit_total_avg = (TextView) view.findViewById(R.id.unit_total_avg);
...
//                        String strAvgHashrate = new DecimalFormat("#.#").format(averageHashrate/1000000);
                            double dbconvertTotalAvgHashrate = (double) averageHashrate + yourWorkerTotal.getAvg();
...
//                        String strReportedHashrate = new DecimalFormat("#.#").format(reportedHashrate/1000000);
                        ...
                        if (activity != null) {
                            myPreferences.UpdateMiner(activity, miner);
                        }
                    }
                    else{
                        if(activity != null) {
